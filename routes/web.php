    ...
    Route::group(
        [
            ...
            Route::group(['prefix'=>'offers'],function (){
                ...
                Route::get('all_page','CrudController@getAllOffersPage')->name('offers.all.page');
...
Route::get('admin','Auth\CustomAuthController@admin')->middleware('auth:admin')->name('admiin');
...
Route::get('hospitals_has_doctors','Relation\RelationsController@hospitalHasDoctor');
